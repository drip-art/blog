...
Although most users use Comfy on their personal machine, there are many companies using Comfy to power apps used by millions. We aim to improve reliability of deploying Comfy through better automated tests and versioning. 
...
We’d love to talk to anyone who has ideas for how ComfyUI can be improved. Find us on discord: 